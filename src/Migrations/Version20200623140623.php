 ...
 */
final class Version20200623140623 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE finess (id INT AUTO_INCREMENT NOT NULL, etablissement VARCHAR(255) NOT NULL, adresse VARCHAR(255) NOT NULL, code_postal INT NOT NULL, ville VARCHAR(255) NOT NULL, finess INT NOT NULL, coordinates VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE esin (id INT AUTO_INCREMENT NOT NULL, identifiant_de_la_fiche INT NOT NULL, emission_de_la_fiche DATE NOT NULL, date_derniere_modif DATE NOT NULL, code_finess_etab INT NOT NULL, episode_precedent DATE NOT NULL, envoi_au_cnr VARCHAR(255) NOT NULL, nom_cnr_ou_labo VARCHAR(255) NOT NULL, nb_cas INT NOT NULL, epidemie_cas_groupes LONGTEXT NOT NULL, caractere_nosocomial INT DEFAULT NULL, origine_cas_importes INT NOT NULL, etab_concernes INT NOT NULL, autres_etabs LONGTEXT DEFAULT NULL, code_micro_organisme1 INT NOT NULL, code_micro_organisme2 INT NOT NULL, code_micro_organisme3 INT NOT NULL, code_site_un INT NOT NULL, code_site_deux INT NOT NULL, code_site_trois INT NOT NULL, investigation LONGTEXT DEFAULT NULL, hypothese_cause LONGTEXT DEFAULT NULL, justification LONGTEXT DEFAULT NULL, praticien_hygiene LONGTEXT DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
